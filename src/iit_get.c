static char rcsid[] = "$Id: iit_get.c 84317 2013-01-24 22:35:41Z twu $";
#ifdef HAVE_CONFIG_H
#include <config.h>
#endif
...
static long int
print_interval (unsigned int *lastcoord, long int total,
		char *divstring, unsigned int coordstart, unsigned int coordend, 
